...
@LocalBean
@Singleton
@DependsOn("ProductInitializationSessionBean")
public class OrderInitializationSessionBean1
{
    ...
    private final int listStart = 0;
    private final int listEnd = 200;
    private final int orders = 1;
    
    public OrderInitializationSessionBean1()
    {
    }

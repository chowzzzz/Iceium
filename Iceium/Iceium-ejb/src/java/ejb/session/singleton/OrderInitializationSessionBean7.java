...
public class OrderInitializationSessionBean7
{
    ...
    private final int listStart = 700;
    private final int listEnd = 720;
    private final int orders = 10;

    public OrderInitializationSessionBean7()
    {
    }

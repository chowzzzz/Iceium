...
@LocalBean
@Singleton
@DependsOn("OrderInitializationSessionBean2")
public class OrderInitializationSessionBean3
{
    ...
    private final int listStart = 200;
    private final int listEnd = 400;
    private final int orders = 1;

    public OrderInitializationSessionBean3()
    {
    }

...
@LocalBean
@Singleton
@DependsOn("OrderInitializationSessionBean4")
public class OrderInitializationSessionBean5
{
    ...
    private final int listStart = 400;
    private final int listEnd = 600;
    private final int orders = 1;

    public OrderInitializationSessionBean5()
    {
    }

...
@LocalBean
@Singleton
@DependsOn("OrderInitializationSessionBean3")
public class OrderInitializationSessionBean4
{
    ...
    private final int listStart = 300;
    private final int listEnd = 500;
    private final int orders = 1;

    public OrderInitializationSessionBean4()
    {
    }

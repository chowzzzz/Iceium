...
@LocalBean
@Singleton
@DependsOn("OrderInitializationSessionBean1")
public class OrderInitializationSessionBean2
{
    ...
    private final int listStart = 100;
    private final int listEnd = 300;
    private final int orders = 1;
    
    public OrderInitializationSessionBean2()
    {
    }
